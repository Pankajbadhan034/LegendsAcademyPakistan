...
public class LeagueTeamAdapter extends BaseAdapter {
    ...
    public LeagueTeamAdapter(Context context, ArrayList<LeagueJoinLeagueBean> leagueJoinLeagueBeanArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.league_team_adapter, null);
