...
import com.lap.application.beans.LeagueTeamEditedDataBean;
...
public class LeagueTeamEditScreen extends AppCompatActivity implements IWebServiceCallback {
    LeagueTeamEditedDataBean leagueTeamEditedDataBean;
    String idStr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.league_team_edit_activity);
        ...
        browse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(LeagueTeamEditScreen.this, android.R.layout.select_dialog_item, items);
                AlertDialog.Builder builder = new AlertDialog.Builder(LeagueTeamEditScreen.this);
        ...
        chooseDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog = new Dialog(LeagueTeamEditScreen.this);
                ...
                datesGridView.setAdapter(new DatesGridAdapterForPopup(LeagueTeamEditScreen.this));
                    ...
                    public void onClick(View v) {
                        ...
                        if(leagueListSelected.size()==0){
                            ...
                            SelectedDatesAdapter selectedDatesAdapter = new SelectedDatesAdapter(leagueListSelected, LeagueTeamEditScreen.this);
        ...
        chooseSeason.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datesGridView.setAdapter(new SeasonGridAdapterForPopup(LeagueTeamEditScreen.this));
                    ...
                    public void onClick(View v) {
                        ...
                        if(seasonListSelected.size()==0){
                            ...
                            SelectedDatesAdapter selectedDatesAdapter = new SelectedDatesAdapter(seasonListSelected, LeagueTeamEditScreen.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (teamNameStr == null || teamNameStr.isEmpty()) {
                    Toast.makeText(LeagueTeamEditScreen.this, "Please enter team name", Toast.LENGTH_SHORT).show();
                }
//                else if (descriptionStr == null || descriptionStr.isEmpty()) {
//                    Toast.makeText(LeagueTeamEditScreen.this, "Please enter description", Toast.LENGTH_SHORT).show();
//                }else if (teamType == null || teamType.isEmpty()) {
//                    Toast.makeText(LeagueTeamEditScreen.this, "Please enter team type", Toast.LENGTH_SHORT).show();
//                }else if(leagueListSelected.size()==0){
//                    Toast.makeText(LeagueTeamEditScreen.this, "Please choose league", Toast.LENGTH_SHORT).show();
//                }else if(seasonListSelected.size()==0){
//                    Toast.makeText(LeagueTeamEditScreen.this, "Please choose season", Toast.LENGTH_SHORT).show();
//                }else if (chooseClubStr == null || chooseClubStr.isEmpty() || chooseClubStr.equalsIgnoreCase("Choose Club")) {
//                    Toast.makeText(LeagueTeamEditScreen.this, "Please choose club", Toast.LENGTH_SHORT).show();
//                }else if (chooseCategoryStr == null || chooseCategoryStr.isEmpty() || chooseCategoryStr.equalsIgnoreCase("Choose Category")) {
//                    Toast.makeText(LeagueTeamEditScreen.this, "Please choose category", Toast.LENGTH_SHORT).show();
//                }
                else if (chooseGroupStr == null || chooseGroupStr.isEmpty() || chooseGroupStr.equalsIgnoreCase("Choose Group")) {
                    Toast.makeText(LeagueTeamEditScreen.this, "Please choose group", Toast.LENGTH_SHORT).show();
                }else{
                    leagueSelected="";
                    seasonSelected="";
                    if(leagueListSelected.size()!=0){
                    ...
                    new addAsync(LeagueTeamEditScreen.this).execute();
                }
            }
        });
    ...
    private void getTeamData(){
        if(Utilities.isNetworkAvailable(LeagueTeamEditScreen.this)) {
            ...
            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(LeagueTeamEditScreen.this, nameValuePairList, TEAM_DATA, LeagueTeamEditScreen.this, headers);
            postWebServiceAsync.execute(webServiceUrl);

        } else {
            Toast.makeText(LeagueTeamEditScreen.this, R.string.internet_not_available, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void getEditedData(){
        if(Utilities.isNetworkAvailable(LeagueTeamEditScreen.this)) {
            ...
            String webServiceUrl = Utilities.BASE_URL + "join_league/parent_team_edit_record";

            ArrayList<String> headers = new ArrayList<>();
            headers.add("X-access-uid:"+loggedInUser.getId());
            headers.add("X-access-token:"+loggedInUser.getToken());

            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(LeagueTeamEditScreen.this, nameValuePairList, GET_EDITED_DATA, LeagueTeamEditScreen.this, headers);
            postWebServiceAsync.execute(webServiceUrl);
    ...
    public void onWebServiceResponse(String response, String tag) {
        switch (tag) {
            case TEAM_DATA:
                if(response == null) {
                    Toast.makeText(LeagueTeamEditScreen.this, "Could not connect to server", Toast.LENGTH_SHORT).show();
                } else {
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(LeagueTeamEditScreen.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
                break;
            ...
            case GET_EDITED_DATA:
                if(response == null) {
                    ...
                    try {
                        ...
                        if(status) {
                            JSONObject jsonObject = responseObject.getJSONObject("data");
                            leagueTeamEditedDataBean = new LeagueTeamEditedDataBean();
                            leagueTeamEditedDataBean.setId(jsonObject.getString("id"));
                            leagueTeamEditedDataBean.setAcademy_id(jsonObject.getString("academy_id"));
                            leagueTeamEditedDataBean.setName(jsonObject.getString("name"));
                            leagueTeamEditedDataBean.setDescription(jsonObject.getString("description"));
                            leagueTeamEditedDataBean.setLeague(jsonObject.getString("league"));
                            leagueTeamEditedDataBean.setSeason(jsonObject.getString("season"));
                            leagueTeamEditedDataBean.setSort(jsonObject.getString("sort"));
                            leagueTeamEditedDataBean.setFile_name(jsonObject.getString("file_name"));
                            leagueTeamEditedDataBean.setCategory(jsonObject.getString("category"));
                            leagueTeamEditedDataBean.setGroups(jsonObject.getString("groups"));
                            leagueTeamEditedDataBean.setPlayer(jsonObject.getString("player"));
                            leagueTeamEditedDataBean.setClub(jsonObject.getString("club"));
                            leagueTeamEditedDataBean.setType(jsonObject.getString("type"));
                            leagueTeamEditedDataBean.setSports_id(jsonObject.getString("sports_id"));
                            leagueTeamEditedDataBean.setState(jsonObject.getString("state"));
                            leagueTeamEditedDataBean.setCreated_by(jsonObject.getString("created_by"));


                            teamName.setText(leagueTeamEditedDataBean.getName());

                            if(leagueTeamEditedDataBean.getType().equalsIgnoreCase("1")){
                                teamType = "1";
                                r1.setChecked(true);
                                r2.setChecked(false);
                            }else if(leagueTeamEditedDataBean.getType().equalsIgnoreCase("2")){
                                teamType = "2";
                                r1.setChecked(false);
                                r2.setChecked(true);
                            }
                            ...
                            if(leagueTeamEditedDataBean.getLeague().equalsIgnoreCase("") || leagueTeamEditedDataBean.getLeague().equalsIgnoreCase("null")){

                            }else{
                                for(LeagueAddPlayerTeamBean leagueAddPlayerTeamBean : leagueList){
                                    List<String> items = Arrays.asList(leagueTeamEditedDataBean.getLeague().split("\\s*,\\s*"));
                            ...
                            if(leagueTeamEditedDataBean.getSeason().equalsIgnoreCase("") || leagueTeamEditedDataBean.getSeason().equalsIgnoreCase("null")){

                            }else{
                                for(LeagueAddPlayerTeamBean leagueAddPlayerTeamBean : seasonList){
                                    List<String> items = Arrays.asList(leagueTeamEditedDataBean.getSeason().split("\\s*,\\s*"));
                                    for(String item : items){
                                        if(item.equalsIgnoreCase(leagueAddPlayerTeamBean.getId())){
                                            leagueAddPlayerTeamBean.setSelected(true);
                                        }
                            ...
                            if(leagueTeamEditedDataBean.getClub().equalsIgnoreCase("") || leagueTeamEditedDataBean.getClub().equalsIgnoreCase("null")){

                            }else{
                                for(LeagueAddPlayerTeamBean leagueAddPlayerTeamBean : clubList){
                                    if(leagueAddPlayerTeamBean.getId().equalsIgnoreCase(leagueTeamEditedDataBean.getClub())){
                            ...
                            if(leagueTeamEditedDataBean.getCategory().equalsIgnoreCase("") || leagueTeamEditedDataBean.getCategory().equalsIgnoreCase("null")){

                            }else{
                                for(LeagueAddPlayerTeamBean leagueAddPlayerTeamBean : categoryList){
                                    if(leagueAddPlayerTeamBean.getId().equalsIgnoreCase(leagueTeamEditedDataBean.getCategory())){
                                        categoryIdStr = leagueAddPlayerTeamBean.getId();
                                        chooseCategory.setText(leagueAddPlayerTeamBean.getName());
                                    }
                                }
                            }

                            if(leagueTeamEditedDataBean.getGroups().equalsIgnoreCase("") || leagueTeamEditedDataBean.getGroups().equalsIgnoreCase("null")){

                            }else{
                                for(LeagueAddPlayerTeamBean leagueAddPlayerTeamBean : groupList){
                                    if(leagueAddPlayerTeamBean.getId().equalsIgnoreCase(leagueTeamEditedDataBean.getGroups())){
                                        groupIdStr = leagueAddPlayerTeamBean.getId();
                                        chooseGroup.setText(leagueAddPlayerTeamBean.getName());
                                    }
                                }
                            }


                            if(leagueTeamEditedDataBean.getDescription().equalsIgnoreCase("")){

                            }else{
                                descriptionStr = leagueTeamEditedDataBean.getDescription();
    ...
    private void showSDKchooseDialog(final TextView textView, final String title, final ArrayList<LeagueAddPlayerTeamBean> arrayList) {
        ...
        listViewDialog.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                }else if(title.equalsIgnoreCase("Choose Group")){
        ...
        LeagueSelectTeamFieldsDataAdapter patientAlertAdapter = new LeagueSelectTeamFieldsDataAdapter(LeagueTeamEditScreen.this, arrayList);
        ...
        switch (requestCode) {
            ...
            case CHOOSE_IMAGE_FROM_GALLERY:
                try {
                    ...
                    Cursor cursor = LeagueTeamEditScreen.this.getContentResolver().query(selectedUri, filePathColumn, null, null, null);
                    cursor.moveToFirst();
...
//                    Toast.makeText(getApplicationContext(), "User cancelled image capture", Toast.LENGTH_SHORT).show();
    ...
    private class addAsync extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            String uploadUrl = Utilities.BASE_URL + "join_league/parent_team_edit";
...
//
//
                System.out.println("TeamType::"+teamType+" id:: "+idStr+"AcademyId :: "+loggedInUser.getAcademiesId() +" User Id:: "+loggedInUser.getId()+
...
//                builder.addPart("team_group", teamGroupBody);
                ...
                System.out.println("File upload endHERE");

            } catch (Exception e) {
                e.printStackTrace();
                System.out.println("ExceptionHERE " + e.getMessage());
            }
        ...
        protected void onPostExecute(String response) {
            ...
            if (response == null) {
                Toast.makeText(LeagueTeamEditScreen.this, "Could not connect server", Toast.LENGTH_SHORT).show();
            } else {
                try {
                    JSONObject responseObject = new JSONObject(response);
                    ...
                    Toast.makeText(LeagueTeamEditScreen.this, message, Toast.LENGTH_SHORT).show();
    ...
    public String getMimeType(Uri uri) {
        ...
        if (uri.getScheme().equals(ContentResolver.SCHEME_CONTENT)) {
            ContentResolver cr = LeagueTeamEditScreen.this.getContentResolver();
