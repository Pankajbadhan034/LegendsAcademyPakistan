...
public class LeagueSelectTeamFieldsDataAdapter extends BaseAdapter {
    ...
    public LeagueSelectTeamFieldsDataAdapter(Context context, ArrayList<LeagueAddPlayerTeamBean> leagueJoinLeagueBeanArrayList) {
