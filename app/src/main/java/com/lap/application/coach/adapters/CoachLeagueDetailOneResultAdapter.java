...
public class CoachLeagueDetailOneResultAdapter extends BaseAdapter {

    SharedPreferences sharedPreferences;
    UserBean loggedInUser;

    Context context;
    ArrayList<CoachLeagueDetailOneResultMatchBean> coachLeagueDetailOneFixtureBeanArrayList;
    LayoutInflater layoutInflater;

    ImageLoader imageLoader = ImageLoader.getInstance();
    DisplayImageOptions roundOptions;

    public CoachLeagueDetailOneResultAdapter(Context context, ArrayList<CoachLeagueDetailOneResultMatchBean> coachLeagueDetailOneFixtureBeanArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.coach_adapter_result_item, null);
        ...
        final CoachLeagueDetailOneResultMatchBean coachLeagueDetailOneFixtureBean = coachLeagueDetailOneFixtureBeanArrayList.get(position);
