...
public class CoachSelectMidweekPackageAdapter extends BaseAdapter {

    SharedPreferences sharedPreferences;
    UserBean loggedInUser;

    Context context;
    ArrayList<LeagueAddPlayerTeamBean> leagueJoinLeagueBeanArrayList;
    ...
    public CoachSelectMidweekPackageAdapter(Context context, ArrayList<LeagueAddPlayerTeamBean> leagueJoinLeagueBeanArrayList, String titleStr) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final LeagueAddPlayerTeamBean leagueJoinLeagueBean = leagueJoinLeagueBeanArrayList.get(position);
        name.setText(titleStr+", "+leagueJoinLeagueBean.getName()+" Sessions");
