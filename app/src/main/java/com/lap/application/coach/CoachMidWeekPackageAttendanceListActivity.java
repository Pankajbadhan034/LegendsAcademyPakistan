...
import com.lap.application.coach.adapters.CoachMidWeekPackageAttendanceListAdapter;
...
public class CoachMidWeekPackageAttendanceListActivity extends AppCompatActivity implements IWebServiceCallback {
   ...
   public static ArrayList<Chapter> chapterArrayList;
    public static CoachMidWeekPackageAttendanceListAdapter coachMidWeekPackageAttendanceListAdapter;
    Typeface helvetica;
    Typeface linoType;
    TextView childName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.coach_mid_week_package_attendance_list_activity);
        ...
        if (intent != null) {
            ...
            coachMidWeekPackageAttendanceListAdapter = new CoachMidWeekPackageAttendanceListAdapter(CoachMidWeekPackageAttendanceListActivity.this, chapterArrayList);
            listView.setAdapter(coachMidWeekPackageAttendanceListAdapter);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                //    Toast.makeText(CoachMidWeekPackageAttendanceListActivity.this, "N/A", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    for (int i = 0; i <= position; i++) {
                        ...
                        if (chapterArrayList.get(i).getChapterName().equalsIgnoreCase("")) {
                            if(i==position){
                                ...
                                Toast.makeText(CoachMidWeekPackageAttendanceListActivity.this, "Please submit attendance of previous credit first", Toast.LENGTH_SHORT).show();
                                break;
                            }
                        }
...
//                         childIdStrSend = ""+chapterArrayList.get(position).getChildId();
//                         attendanceId = ""+chapterArrayList.get(position).getAttendance_id();
//                         attendance_date = ""+chapterArrayList.get(position).getChapterName();
//                         attendance_state = "1";
//                         orderId = chapterArrayList.get(position).getOrderMidWeekSessionId();


//                        strChildrenAttendance = "[";
//
//                        strChildrenAttendance += "{\"child_id\":\""+childIdStrSend+"\", \"attendance_id\":\""+attendanceId+"\"},";
//
//                        strChildrenAttendance += "]";
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                strChildrenAttendance = strChildrenAttendance.replace("[,","[");


                System.out.println("HEREaa"+strChildrenAttendance);

                if(strChildrenAttendance.equalsIgnoreCase("[]")){
                    Toast.makeText(CoachMidWeekPackageAttendanceListActivity.this, "Please select attendance", Toast.LENGTH_SHORT).show();
...
//
    ...
    private void midWeekAttendance() {
        if(Utilities.isNetworkAvailable(CoachMidWeekPackageAttendanceListActivity.this)) {
...
//            nameValuePairList.add(new BasicNameValuePair("session_id", "782"));
            ...
            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(CoachMidWeekPackageAttendanceListActivity.this, nameValuePairList, MARK_ATTENDANCE, CoachMidWeekPackageAttendanceListActivity.this, headers);
            postWebServiceAsync.execute(webServiceUrl);

        } else {
            Toast.makeText(CoachMidWeekPackageAttendanceListActivity.this, R.string.internet_not_available, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onWebServiceResponse(String response, String tag) {
        switch (tag) {
            case MARK_ATTENDANCE:
                ...
                if(response == null) {
                    Toast.makeText(CoachMidWeekPackageAttendanceListActivity.this, "Could not connect to server", Toast.LENGTH_SHORT).show();
                } else {
                    try {
                        ...
                        if(status==true){
                         ...
                         //   CoachMidWeekPackageChildNamesAttendanceActivity.finishCoachMidPackageCHildNamesAtttendanceActivity = true;
                           finish();
                        }else{
                            Toast.makeText(CoachMidWeekPackageAttendanceListActivity.this, message, Toast.LENGTH_SHORT).show();
                        }
                        ...
                        e.printStackTrace();
                        Toast.makeText(CoachMidWeekPackageAttendanceListActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
...
//            dob.setText(strDay+"-"+strMonth+"-"+year);
           ...
           String dateEdit =  year+"-"+strMonth+"-"+day;
            String newDateFormat =  day+"-"+strMonth+"-"+year;
               chapterArrayList.get(position).setChapterName(dateEdit);
               chapterArrayList.get(position).setNewDateFormat(newDateFormat);
               chapterArrayList.get(position).setStatus("1");
               coachMidWeekPackageAttendanceListAdapter.notifyDataSetChanged();
           }
