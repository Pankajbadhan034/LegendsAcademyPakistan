        ...
        submitSessionDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (strEmail == null || strEmail.isEmpty()) {
                    Toast.makeText(CoachUnpaidPlayersScreen.this, "Please search with parent email or "+verbiage_singular+" name to add "+verbiage_singular+".", Toast.LENGTH_SHORT).show();
//                    Toast.makeText(CoachUnpaidPlayersScreen.this, "Please search parent email to add "+verbiage_singular, Toast.LENGTH_SHORT).show();
                    ...
                    if(addNewChildBool==true){
                        ...
                        if(strCheckEmail.equalsIgnoreCase(strEmail)){
                            ...
                            Toast.makeText(CoachUnpaidPlayersScreen.this, "Please search again parent email or "+verbiage_singular+" name", Toast.LENGTH_SHORT).show();
                        }
...
//                newFragment.show(getSupportFragmentManager(), "datePicker");
               ...
               String strName = partNameET.getText().toString().trim();
                ...
                if (strName == null || strName.isEmpty()) {
                    ...
                    if(Utilities.isNetworkAvailable(CoachUnpaidPlayersScreen.this)) {
                        ...
                        PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(CoachUnpaidPlayersScreen.this, nameValuePairList, SEARCH_PART_NAME, CoachUnpaidPlayersScreen.this, headers);
    ...
    private void getParentEmail(String id){
        if(Utilities.isNetworkAvailable(CoachUnpaidPlayersScreen.this)) {
            ...
            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(CoachUnpaidPlayersScreen.this, nameValuePairList, PARENT_EMAIL_GET, CoachUnpaidPlayersScreen.this, headers);
            postWebServiceAsync.execute(webServiceUrl);
                    ...
                    try{
                        ...
                        if(status) {
                            ...
                            if(coachUnpaidParticipantBeanArrayList.size()==0){
                                ...
                                final Dialog dialog = new Dialog(CoachUnpaidPlayersScreen.this);
                                ...
                                CoachUnpaidPlayerParticipantAdapter coachUnpaidPlayerParticipantAdapter = new CoachUnpaidPlayerParticipantAdapter(CoachUnpaidPlayersScreen.this, coachUnpaidParticipantBeanArrayList);
