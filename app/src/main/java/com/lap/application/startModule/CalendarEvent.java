...
public class CalendarEvent extends LinearLayout implements View.OnClickListener {
    ...
    public CalendarEvent(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ...
        if (previousLeftMonthDays != 0) {
            ...
            for (int i = 0; i < previousLeftMonthDays; i++) {
                ...
                if (model.isHaveEvent()) {
                    ...
                    eventsTextViewList[index].setTextSize(12);
                } else {
                ...
                days[index].setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
    ...
    private void initDaysInCalender(LinearLayout.LayoutParams buttonParams, Context context, DisplayMetrics metrics) {
