...
public class ParticipantMainAdapter extends BaseAdapter {
    ...
    public ParticipantMainAdapter(Context context, ArrayList<ParentDashboardBean> parentDashboardBeanArrayList){
