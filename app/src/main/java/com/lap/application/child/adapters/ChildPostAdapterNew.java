 ...
 */
public class ChildPostAdapterNew extends BaseAdapter implements IWebServiceCallback {
...
//    CallbackManager callbackManager;
    ...
    public ChildPostAdapterNew(Context context, ArrayList<ChildPostsBean> childPostsBeanArrayList, ChildPostFragment childPostFragment){
...
//            System.out.println("ChildPostAdapterNew:: video thumbnail "+childPostsBean.getVideoThumbnail());
            ...
            public void onClick(View v) {
                if(Utilities.isNetworkAvailable(context)) {
                    if(childPostsBean.getChallengeAction().equalsIgnoreCase("approval_required_friend_reqst")){
                            ...
                            public void onClick(View v) {
                                ...
                                if (parentPasswordStr == null || parentPasswordStr.isEmpty()) {
                                    ...
                                    if (Utilities.isNetworkAvailable(context)) {
                                        ...
                                        PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, ACCEPT_OR_REJECT_APPROVAL_REQUEST, ChildPostAdapterNew.this, headers);
                        ...
                        PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, ACCEPT_OR_REJECT_FRIEND, ChildPostAdapterNew.this, headers);
                        postWebServiceAsync.execute(webServiceUrl);
                    }
                ...
                if(childPostsBean.getIsLikeByYou().equalsIgnoreCase("false")){
                    ...
                    if(childPostsBean.getLocalType().equalsIgnoreCase("timeline")){
                        if(childPostsBean.getApprovalStatus().equalsIgnoreCase("approval_required_timeline")){
                                ...
                                public void onClick(View v) {
                                    ...
                                    if(parentPasswordStr==null || parentPasswordStr.isEmpty()){
                                        ...
                                        if(Utilities.isNetworkAvailable(context)) {
                                            ...
                                            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, APPROVAL_TIMELINE, ChildPostAdapterNew.this, headers);
                                            postWebServiceAsync.execute(webServiceUrl);
                                        }else{
                                            Toast.makeText(context, R.string.internet_not_available, Toast.LENGTH_SHORT).show();
                                        }
                            ...
                            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, LIKE_UNLIKE, ChildPostAdapterNew.this, headers);
                            postWebServiceAsync.execute(webServiceUrl);
                        }
                    ...
                    public void onClick(View v) {
                        if (Utilities.isNetworkAvailable(context)) {
                            ...
                            if (childPostsBean.getChallengeIsShared().equalsIgnoreCase("1")) {
                                ...
                                PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, POST_SHARE, ChildPostAdapterNew.this, headers);
                                postWebServiceAsync.execute(webServiceUrl);
                            }
                       ...
                       new DialogInterface.OnClickListener() {
                           public void onClick(DialogInterface dialog, int id) {
                               ...
                               if (Utilities.isNetworkAvailable(context)) {
                                   ...
                                   PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, POST_DELETE, ChildPostAdapterNew.this, headers);
                                   postWebServiceAsync.execute(webServiceUrl);
                               } else {
                                   Toast.makeText(context, R.string.internet_not_available, Toast.LENGTH_SHORT).show();
                               }
            ...
            public void onClick(View v) {
                if(Utilities.isNetworkAvailable(context)) {
                    ...
                    if(childPostsBean.getChallengeChallengeStatus().equalsIgnoreCase("set_challenge")){
                        ...
                        PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, ACCEPT_CHALLENGE, ChildPostAdapterNew.this, headers);
                        postWebServiceAsync.execute(webServiceUrl);
                                ...
                                public void onClick(View v) {
                                    ...
                                    if(parentPasswordStr==null || parentPasswordStr.isEmpty()){
                                        ...
                                        if(Utilities.isNetworkAvailable(context)) {
                                            ...
                                            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, APPROVAL_CHALLENGE, ChildPostAdapterNew.this, headers);
                                            postWebServiceAsync.execute(webServiceUrl);
                                        }else{
                                            Toast.makeText(context, R.string.internet_not_available, Toast.LENGTH_SHORT).show();
                                        }
...
//                    System.out.println("ingored_challenge_called");
                    ...
                    headers.add("X-access-uid:"+loggedInUser.getId());
                    headers.add("X-access-token:" + loggedInUser.getToken());
                    PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(context, nameValuePairList, IGNORE_CHALLENGE, ChildPostAdapterNew.this, headers);
                    postWebServiceAsync.execute(webServiceUrl);
