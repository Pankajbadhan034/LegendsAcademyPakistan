...
public class ParentChildDetailAdapter  extends BaseAdapter {
    ...
    public ParentChildDetailAdapter(Context context, ArrayList<DataRegistrationBean> dataRegistrationBeanArrayList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.parent_child_detail_adapter, null);
