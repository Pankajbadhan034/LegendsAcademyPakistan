...
public class ParentPitchBookingDatesAdapter extends BaseAdapter implements IWebServiceCallback{
...
//    private final String REMOVE_SLOT = "REMOVE_SLOT";
    ...
    public ParentPitchBookingDatesAdapter(Context context, ArrayList<PitchBookingDateBean> bookingDatesList, ParentPitchSummaryAdapter parentPitchSummaryAdapter, ListView pitchesDetailListView, ListView bookingDatesListView, String pitchId){
