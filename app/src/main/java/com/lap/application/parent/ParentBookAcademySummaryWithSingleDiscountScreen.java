...
import com.lap.application.parent.adapters.ParentAcademySessionSummaryWithSingleDiscountAdapter;
...
public class ParentBookAcademySummaryWithSingleDiscountScreen extends AppCompatActivity implements IWebServiceCallback{
    double sendNetAmount = 0;
...
//    BookingHistoryDiscountBean discountBean = new BookingHistoryDiscountBean();
    ...
    ParentAcademySessionSummaryWithSingleDiscountAdapter parentAcademySessionSummaryAdapter;
...
//        discountDescription = findViewById(R.id.discountDescription);
        ...
        parentAcademySessionSummaryAdapter = new ParentAcademySessionSummaryWithSingleDiscountAdapter(ParentBookAcademySummaryWithSingleDiscountScreen.this, summaryList, ParentBookAcademySummaryWithSingleDiscountScreen.this, summaryListView /*, discountBean*/);
        ...
        makePayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(summaryList == null || summaryList.isEmpty()) {
                    Toast.makeText(ParentBookAcademySummaryWithSingleDiscountScreen.this, "Please select a session", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//                    strBookingDetails += "{\"sessions_id\":\""+sessionId+"\",\"children_details\":"+childrenInfo+",\"session_cost\":\""+sessionCost+"\",\"session_payment\":\""+sessionPayment+"\",\"is_trial\":\""+strIsTrial+"\",\"booking_dates\":"+strBookingDates+"},";
                ...
                if(Utilities.isNetworkAvailable(ParentBookAcademySummaryWithSingleDiscountScreen.this)) {
...
//                    nameValuePairList.add(new BasicNameValuePair("net_amount", dblNetAmount+""));
                    ...
                    if(netAmount.getText().toString().trim().equals("0.00 "+academy_currency)){
                        ...
                        nameValuePairList.add(new BasicNameValuePair("total_amount", ""+sendNetAmount));
                    }
                    ...
                    PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(ParentBookAcademySummaryWithSingleDiscountScreen.this, nameValuePairList, BOOK_SESSION, ParentBookAcademySummaryWithSingleDiscountScreen.this, headers);
                    postWebServiceAsync.execute(webServiceUrl);

                } else {
                    Toast.makeText(ParentBookAcademySummaryWithSingleDiscountScreen.this, R.string.internet_not_available, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        applyPromoCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(dblNetAmount == 0) {
                    ...
                    double dblNetFinal = 0;
                    dblNetFinal = dblNetAmount - bulkDouble;
                    sendNetAmount = dblNetFinal;

                    netAmount.setText(decimalFormat.format(dblNetFinal)+" "+academy_currency);
                }

                if(strPromoCode == null || strPromoCode.isEmpty()) {
                    Toast.makeText(ParentBookAcademySummaryWithSingleDiscountScreen.this, "Please enter Promo Code", Toast.LENGTH_SHORT).show();
                } else {
                    if(Utilities.isNetworkAvailable(ParentBookAcademySummaryWithSingleDiscountScreen.this)) {

                        List<NameValuePair> nameValuePairList = new ArrayList<>();
                        System.out.println("HERE:: "+totalDiscountNew);
                        ...
                        PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(ParentBookAcademySummaryWithSingleDiscountScreen.this, nameValuePairList, APPLY_PROMO_CODE, ParentBookAcademySummaryWithSingleDiscountScreen.this, headers);
                        postWebServiceAsync.execute(webServiceUrl);
...
//                if(BuldDiscountNew.equalsIgnoreCase("0")){
//                    bulkDiscount.setText("0.00 "+academy_currency);
//                }else{
//                    bulkDiscount.setText("- "+BuldDiscountNew+" "+academy_currency);
//                }

                if(totalDiscountNew == 0) {
                    discount.setText("0.00 "+academy_currency);
                } else {
                    discount.setText("- "+ decimalFormat.format(totalDiscountNew)+" "+academy_currency);
                }
        ...
        clearAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(ParentBookAcademySummaryWithSingleDiscountScreen.this);
...
//                ParentAcademyListingFragment.comingFromBookMore = true; // Old
                ...
                Intent mainScreen = new Intent(ParentBookAcademySummaryWithSingleDiscountScreen.this, ParentMainScreen.class);
                ...
                Intent screenOne = new Intent(ParentBookAcademySummaryWithSingleDiscountScreen.this, ParentAcademyListingWithFiltersScreen.class);
...
//            Set<String> keys = applicationContext.getBookAcademySummaryData().keySet();
            ...
            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(ParentBookAcademySummaryWithSingleDiscountScreen.this, nameValuePairList, GET_SUMMARY_DATA, ParentBookAcademySummaryWithSingleDiscountScreen.this, headers);
            postWebServiceAsync.execute(webServiceUrl);
    ...
    public void onWebServiceResponse(String response, String tag) {
        switch (tag) {
            case GET_SUMMARY_DATA:
                ...
                if (response == null) {
                    Toast.makeText(ParentBookAcademySummaryWithSingleDiscountScreen.this, "Could not connect to server", Toast.LENGTH_SHORT).show();
                } else {
                    try {
...
//                                    dateBean.setSelected(false);
                        ...
                        e.printStackTrace();
                        Toast.makeText(ParentBookAcademySummaryWithSingleDiscountScreen.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
                parentAcademySessionSummaryAdapter.notifyDataSetChanged();
                Utilities.setListViewHeightBasedOnChildren(summaryListView);
                calculateFees();
                warningListView.setAdapter(new WarningAdapter(ParentBookAcademySummaryWithSingleDiscountScreen.this, warningList));
                    ...
                    try {
                        ...
                        if(status) {
                            ...
                            if(netAmount.getText().toString().trim().equals(".00 "+academy_currency) || netAmount.getText().toString().trim().equals("0.00 "+academy_currency) || netAmount.getText().toString().trim().equals("0 "+academy_currency) || netAmount.getText().toString().trim().equals(".0 "+academy_currency) || netAmount.getText().toString().trim().equals("0.0 "+academy_currency)){
                                ...
                                //Toast.makeText(ParentBookAcademySummaryWithSingleDiscountScreen.this, message, Toast.LENGTH_SHORT).show();
                                Intent mainScreen = new Intent(ParentBookAcademySummaryWithSingleDiscountScreen.this, ParentNetPaymentZeroScreen.class);
...
//                                    headers.add("X-access-token:"+loggedInUser.getToken());
//
//                                    PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(ParentBookAcademySummaryWithSingleDiscountScreen.this, nameValuePairList, TELR_STATUS, ParentBookAcademySummaryWithSingleDiscountScreen.this, headers);
//                                    postWebServiceAsync.execute(webServiceUrl);
//
//                                } else {
//                                    Toast.makeText(ParentBookAcademySummaryWithSingleDiscountScreen.this, R.string.internet_not_available, Toast.LENGTH_SHORT).show();
            ...
            case HITPAY_ID_STORE_SERVICE:
                if (response == null) {
                    ...
                    try {
                        ...
                        if(status) {
                            Intent obj = new Intent(ParentBookAcademySummaryWithSingleDiscountScreen.this, HitPayExample.class);
...
//                            editor.commit();
//
//                            Intent intent = new Intent(ParentBookAcademySummaryWithSingleDiscountScreen.this, WebviewActivity.class);
            ...
            case APPLY_PROMO_CODE:
                ...
                if (response == null) {
                    ...
                    try {
                        ...
                        Toast.makeText(ParentBookAcademySummaryWithSingleDiscountScreen.this, message, Toast.LENGTH_LONG).show();
                            ...
                            try{
                              ...
                              //  bulkDiscount.setText("0.00 "+academy_currency);
                                ...
                                if(dblNetAmount == 0) {
                                    ...
                                    System.out.println("HereValue::"+decimalFormat.format(dblNetAmount));

                                    double dblNetFinal = 0;
//                                    dblNetFinal = dblNetAmount - bulkDouble;
                                    dblNetFinal = dblNetAmount + totalDiscountNew;
                                    sendNetAmount = dblNetFinal;
                                    netAmount.setText(decimalFormat.format(dblNetFinal)+" "+academy_currency);
                                }

                            } catch (NumberFormatException e){
                                Toast.makeText(ParentBookAcademySummaryWithSingleDiscountScreen.this, "Invalid discount", Toast.LENGTH_SHORT).show();
                            }
                        }
...
//    }
    ...
    public void hitPaycheck(){
        if(Utilities.isNetworkAvailable(ParentBookAcademySummaryWithSingleDiscountScreen.this)) {
            ...
            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(ParentBookAcademySummaryWithSingleDiscountScreen.this, nameValuePairList, HITPAY_STATUS, ParentBookAcademySummaryWithSingleDiscountScreen.this, headers);
            postWebServiceAsync.execute(webServiceUrl);
    ...
    public void hitPaysAPI(String api_key){
        if (Utilities.isNetworkAvailable(ParentBookAcademySummaryWithSingleDiscountScreen.this)) {
            ...
            HitPayPostWebServiceWithHeadersAsync postWebServiceAsync = new HitPayPostWebServiceWithHeadersAsync(ParentBookAcademySummaryWithSingleDiscountScreen.this, nameValuePairList, HITPAY_WEB_SERVICE, ParentBookAcademySummaryWithSingleDiscountScreen.this, api_key);
            postWebServiceAsync.execute(webServiceUrl);
        } else {
            Toast.makeText(ParentBookAcademySummaryWithSingleDiscountScreen.this, R.string.internet_not_available, Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void hitPayIdStoreAPI(String id){
        if(Utilities.isNetworkAvailable(ParentBookAcademySummaryWithSingleDiscountScreen.this)) {
            ...
            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(ParentBookAcademySummaryWithSingleDiscountScreen.this, nameValuePairList, HITPAY_ID_STORE_SERVICE, ParentBookAcademySummaryWithSingleDiscountScreen.this, headers);
            postWebServiceAsync.execute(webServiceUrl);
    ...
    public void termSettingAPI(){
        if(Utilities.isNetworkAvailable(ParentBookAcademySummaryWithSingleDiscountScreen.this)) {
            ...
            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(ParentBookAcademySummaryWithSingleDiscountScreen.this, nameValuePairList, TERM_COND_SETTING, ParentBookAcademySummaryWithSingleDiscountScreen.this, headers);
            postWebServiceAsync.execute(webServiceUrl);
    ...
    public void updateTermSettingAPI(){
        if(Utilities.isNetworkAvailable(ParentBookAcademySummaryWithSingleDiscountScreen.this)) {
            ...
            PostWebServiceWithHeadersAsync postWebServiceAsync = new PostWebServiceWithHeadersAsync(ParentBookAcademySummaryWithSingleDiscountScreen.this, nameValuePairList, UPDATE_TERM_COND_SETTING, ParentBookAcademySummaryWithSingleDiscountScreen.this, headers);
            postWebServiceAsync.execute(webServiceUrl);
    ...
    public void dialogBoxShow(String text){
        ...
        final Dialog dialogAddNotes = new Dialog(ParentBookAcademySummaryWithSingleDiscountScreen.this);
