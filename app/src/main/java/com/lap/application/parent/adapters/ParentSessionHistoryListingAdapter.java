...
public class ParentSessionHistoryListingAdapter extends BaseAdapter {
    ...
    public ParentSessionHistoryListingAdapter(Context context, ArrayList<SessionHistoryBean> sessionHistoryList) {
