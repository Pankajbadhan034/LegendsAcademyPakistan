...
public class ParentMidWeekPackageChildNamesAttendanceAdapter extends BaseAdapter {
    ...
    public ParentMidWeekPackageChildNamesAttendanceAdapter(Context context, ArrayList<RecycleExpBean> membersList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.parent_adapter_midweek_child_attendance_item, null);
