...
public class ParentChildrenListingForSpinnerAdapter extends BaseAdapter{
    ...
    public ParentChildrenListingForSpinnerAdapter(Context context, ArrayList<ChildBean> childrenListing) {
