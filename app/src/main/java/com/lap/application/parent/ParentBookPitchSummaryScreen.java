...
import com.lap.application.parent.adapters.ParentPitchSummaryAdapter;
                        ...
                        if(status) {
                            if(isBookMore){
                                if(loggedInUser.getRoleCode().equalsIgnoreCase("participant_role")){
                                    Intent mainScreen = new Intent(ParentBookPitchSummaryScreen.this, ParticipantMainScreen.class);
