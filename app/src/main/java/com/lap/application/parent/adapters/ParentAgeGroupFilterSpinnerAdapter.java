...
public class ParentAgeGroupFilterSpinnerAdapter extends BaseAdapter{

    Context context;
    ArrayList<AgeGroupFilterBean> academyLocationBean;
    LayoutInflater layoutInflater;
    Typeface helvetica;
    Typeface linoType;

    public ParentAgeGroupFilterSpinnerAdapter(Context context, ArrayList<AgeGroupFilterBean> academyLocationBean) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        locationName.setText(academyLocationBean.get(position).getGroupName());
